...
module.exports = FlyingAssetsPlugin;

function FlyingAssetsPlugin(template) {
  this.render = compileFile(template);
  this.assets = {};
}

FlyingAssetsPlugin.prototype.apply = function (compiler) {
  this.compiler = compiler;
  compiler.plugin('emit', this.compile.bind(this));
};

FlyingAssetsPlugin.prototype.compile = function (compilation, callback) {
